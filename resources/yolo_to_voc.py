...
# https://github.com/carolinepacheco/convert-yolo-to-pascalvoc/blob/master/yolo_to_voc.py
...
## coco classes
YOLO_CLASSES = ('open_manhole', 'closed_manhole', 'improperly_closed_manhole')
...
## path root folder
ROOT = 'D:/Project_2-2/RSIP_project/New_Paper_VIT/dataset/obj'
...
def xml_transform(root, classes):  
    ...
    for i in range(len(ids)):
        ...
        node_database.text = 'manhole database'
